...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Document.salt'
        db.alter_column(u'cryptoshare_document', 'salt', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    models = {
        u'cryptoshare.document': {
            ...
            'salt': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
